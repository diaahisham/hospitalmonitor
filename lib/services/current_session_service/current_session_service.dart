...
class CurrentSessionService {
  ...
  UserModel patientUser = UserModel();
  UserModel nonPatientUser = UserModel();
  ...
  set loggedUser(UserModel user) {
    ...
    window.sessionStorage[this.sessionKey] = encryptedUserData;
    if (_loggedUser.type == UserType.patient)
      patientUser = _loggedUser;
    else
      nonPatientUser = _loggedUser;
  }
